...
$(function () {
    ...
    $('#addToCart, #addCart_bottom').click(function () {
        ...
        if (t.attr('data-ck') == 1) {
            ...
            msgSize.html('<div class="alert alert-warning fade show alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>Vui lòng chọn Màu và Size để mua hàng</div>');
