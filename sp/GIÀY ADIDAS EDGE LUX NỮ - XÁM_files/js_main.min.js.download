...
(function(a) {
	window.CUBER = {
		Nav: {
			...
			mount: function() {
				...
				var openCart = a("#site-cart-handle a");
				var openMenu = a("#site-menu-handle");
				var viewCart = 'miniCart';

				openMenu.on("click focusin", function() {
				...
				openCart.on("click", function(b) {
					...
					if (!in_array(storeId,[53936,7239])) {
						ajaxLoadView({
							view: viewCart,
				...
				a("#site-search-handle a, .clickSearch").on("click", function(b) {
					b.preventDefault();
	...
	a(document).on("ready", function() {
		...
		0 < a(".productDetail-page").length && a(".productDetail-page").each(function () {
			if (typeof window.CUBER.Product != 'undefined') {
